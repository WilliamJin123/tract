...
Chat with an LLM over several turns, then look back at what the context
looked like at earlier points. Finally, reset HEAD to roll back the
conversation — turns 2-3 vanish from the compiled context.
