"""Branch, Switch, and Delete

Try an experimental approach without affecting main. Branch off, chat on
the experiment, switch back to confirm main is untouched, then clean up.
Branching is lightweight — it's just a pointer to a commit, not a copy.
